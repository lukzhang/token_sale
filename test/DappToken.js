...
contract('DappToken', function(accounts){
  ...
  it('initializes the contract with correct values', function(){
    return DappToken.deployed().then(function(instance){
      ...
      assert.equal(symbol, 'DAPP', 'hass correct symbol');
  ...
  it('transfers token ownership', function(){
    return DappToken.deployed().then(function(instance){
      tokenInstance=instance;
      //Test require statment first by transferring something larger than sender's balance
      ...
      assert.equal(balance.toNumber(), 750000, 'dedeucts the amount from sending account');
    });
  });
  ...
  it('handles delegated token transfer', function(){
      return DappToken.deployed().then(function(instance){
        ...
        //Try trasnferring something larger than sender balance
